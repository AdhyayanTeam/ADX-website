  ...
  return (
    <section className="w-full bg-white border-y border-glaucous-200/80 py-24 px-6 relative overflow-hidden">
      ...
      <div className="max-w-3xl mx-auto relative z-10 text-center">
        ...
        <p className="text-base sm:text-lg text-glaucous-900 leading-relaxed mb-6 font-sans">
        ...
        <p className="text-base sm:text-lg text-glaucous-900 leading-relaxed mb-12 font-sans">
        ...
        <div className="border-t border-glaucous-200 pt-12 mt-12">
          <p className="text-base sm:text-lg text-vivid-royal-950 font-semibold leading-relaxed mb-4">
            A customer should get the same answer no matter who picks up the phone.
          </p>
          <p className="text-sm sm:text-base text-glaucous-700 leading-relaxed max-w-2xl mx-auto">
