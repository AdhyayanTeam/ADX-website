...
const INJECTED_STYLES = `
  ...
  .hero-radial-bg {
      background: radial-gradient(circle at center, #FFFFFF 30%, #E3E8EC 100%);
  }
  ...
  .text-3d-matte {
      color: var(--text-flat-color, #FFFFFF);
      text-shadow: 
  ...
  .text-silver-matte {
      background: linear-gradient(180deg, var(--text-grad-start, #FFFFFF) 0%, var(--text-grad-end, #A1A1AA) 100%);
  ...
  .btn-modern-light:hover {
      ...
      box-shadow: 
          ...
          0 16px 28px -6px rgba(15,23,42,0.08),
          inset 0 1px 1px rgba(255,255,255,1);
  }
...
export function CinematicHero({ 
  brandName = "ADX",
  tagline1 = "Build & Automate,",
  tagline2 = "Grow Your Business.",
  cardHeading = "Digital Agency OS.",
  cardDescription = <><span className="text-white font-semibold">ADX</span> empowers modern businesses with custom high-performing websites, intelligent workflow automation, and precision-targeted advertising campaigns.</>,
  metricValue = 98,
  metricLabel = "% Auto Rate",
  ctaHeading = "Ready to Scale?",
  ctaDescription = "Transform your workflow and customer acquisition with custom AI automation and precision marketing.",
  className, 
  ...props 
}: CinematicHeroProps) {
  ...
  useEffect(() => {
    ...
    const ctx = gsap.context(() => {
      ...
      gsap.set([".hero-radial-bg", ".bg-grid-theme"], { opacity: 0, scale: 0.95 });

      const introTl = gsap.timeline({ 
        delay: 0.2,
        onComplete: () => {
          (window as any).__heroLoaderComplete = true;
          window.dispatchEvent(new Event("hero-loader-complete"));
          
          gsap.to(".hero-loader-overlay", {
            opacity: 0,
            duration: 1.0,
            ease: "power2.out",
            onComplete: () => {
              gsap.set(".hero-loader-overlay", { display: "none" });
            }
          });
        }
      });
      ...
      introTl
        .to(".hero-loader-bar", { width: "100%", duration: 1.8, ease: "power2.inOut" })
        .to(".text-track", { duration: 1.5, autoAlpha: 1, y: 0, scale: 1, filter: "blur(0px)", rotationX: 0, ease: "expo.out" }, 0.2)
        .to(".text-days", { duration: 1.2, clipPath: "inset(0 0% 0 0)", ease: "power4.inOut" }, 0.5)
        .to(containerRef.current, {
          "--text-grad-start": "#090A0F",
          "--text-grad-end": "#475569",
          "--text-flat-color": "#0F172A",
          duration: 1.0,
          ease: "power2.out"
        }, 1.8)
        .to(".hero-radial-bg", { opacity: 1, scale: 1, duration: 1.5, ease: "power2.out" }, 1.8)
        .to(".bg-grid-theme", { opacity: 0.5, scale: 1, duration: 1.5, ease: "power2.out" }, 1.8);
  ...
  return (
    <div
      ...
      style={{ 
        ...
        "--text-grad-end": "#A1A1AA",
        "--text-flat-color": "#FFFFFF"
      } as React.CSSProperties}
      {...props}
    >
      <style dangerouslySetInnerHTML={{ __html: INJECTED_STYLES }} />
      
      {/* Intro Pre-loader Dark Screen Overlay */}
      <div className="hero-loader-overlay absolute inset-0 z-5 bg-[#050914] flex flex-col items-center justify-center pointer-events-none">
        <div className="bg-grid-dark absolute inset-0 z-0 opacity-40" aria-hidden="true" />
        <div className="absolute bottom-0 left-0 h-1 bg-accent hero-loader-bar w-0 z-10" />
      </div>

      <div className="hero-radial-bg absolute inset-0 z-0 pointer-events-none" aria-hidden="true" />
      ...
      <div className="cta-wrapper absolute z-10 flex flex-col items-center justify-center text-center w-screen px-4 gsap-reveal pointer-events-auto will-change-transform">
        ...
        <div className="flex flex-col sm:flex-row gap-6">
          <a href="/services" aria-label="Explore Services" className="btn-modern-light flex items-center justify-center gap-2 px-7 py-3 rounded-full group focus:outline-none focus:ring-2 focus:ring-accent">
            <span className="text-sm font-bold tracking-tight">Explore Services</span>
            <svg className="w-4 h-4 transition-transform group-hover:translate-x-1" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M14 5l7 7m0 0l-7 7m7-7H3"/>
            </svg>
          </a>
          <a href="/book" aria-label="Book Call" className="btn-modern-dark flex items-center justify-center gap-2 px-7 py-3 rounded-full group focus:outline-none focus:ring-2 focus:ring-accent">
            ...
            <span className="text-sm font-bold tracking-tight">Book Strategy Call</span>
          </a>
        </div>
      </div>
            ...
            <div className="mockup-scroll-wrapper order-2 lg:order-2 relative w-full h-[380px] lg:h-[600px] flex items-center justify-center z-10" style={{ perspective: "1000px" }}>
              ...
              <div className="relative w-full h-full flex items-center justify-center transform scale-[0.65] md:scale-85 lg:scale-100">
                  ...
                  <div className="absolute inset-[7px] bg-[#050914] rounded-[2.5rem] overflow-hidden shadow-[inset_0_0_15px_rgba(0,0,0,1)] text-white z-10">
                    ...
                    <div className="relative w-full h-full pt-12 px-5 pb-8 flex flex-col">
                      <div className="phone-widget flex justify-between items-center mb-8">
                        ...
                        <div className="w-9 h-9 rounded-full bg-white/5 text-neutral-200 flex items-center justify-center font-bold text-sm border border-white/10 shadow-lg shadow-black/50">ADX</div>
                      </div>
                      ...
                      <div className="space-y-3">
                        <div className="phone-widget widget-depth rounded-2xl p-3 flex items-center">
                          ...
                          <div className="flex-1 text-left">
                            <span className="block text-[10px] text-neutral-300 font-bold">AI Chatbots Online</span>
                            <span className="block text-[8px] text-emerald-400 font-bold">Active & Routing</span>
                          </div>
                        </div>
                        <div className="phone-widget widget-depth rounded-2xl p-3 flex items-center">
                          ...
                          <div className="flex-1 text-left">
                            <span className="block text-[10px] text-neutral-300 font-bold">Leads Routed</span>
                            <span className="block text-[8px] text-blue-400 font-bold">14,285 Processed</span>
                          </div>
                        </div>
                      </div>
                ...
                <div className="floating-badge absolute flex top-6 lg:top-12 left-[-15px] lg:left-[-80px] floating-ui-badge rounded-xl lg:rounded-2xl p-3 lg:p-4 items-center gap-3 lg:gap-4 z-30 text-left">
                  ...
                  <div>
                    <p className="text-white text-xs lg:text-sm font-bold tracking-tight">Conversion Rate</p>
                    <p className="text-blue-200/50 text-[10px] lg:text-xs font-medium">+284% average</p>
                  </div>
                </div>
                ...
                <div className="floating-badge absolute flex bottom-12 lg:bottom-20 right-[-15px] lg:right-[-80px] floating-ui-badge rounded-xl lg:rounded-2xl p-3 lg:p-4 items-center gap-3 lg:gap-4 z-30 text-left">
                  ...
                  <div>
                    <p className="text-white text-xs lg:text-sm font-bold tracking-tight">AI Workflows</p>
                    <p className="text-blue-200/50 text-[10px] lg:text-xs font-medium">Running 24/7</p>
                  </div>
                </div>
