    ...
    <main className="min-h-screen bg-glaucous-50 text-vivid-royal-950 pt-24 pb-20 flex items-center justify-center">
      <div className="w-full max-w-xl mx-auto px-6">
        {isSuccess ? (
          ...
          <div className="bg-ghost-white-50 border border-glaucous-200 rounded-xl overflow-hidden shadow-xl">
            <div className="bg-glaucous-100 px-6 py-4 border-b border-glaucous-200 flex items-center justify-between">
              ...
              <span className="font-mono text-base px-2 py-0.5 rounded-lg bg-coffee-bean-50 text-coffee-bean-600 border border-coffee-bean-200 uppercase font-bold">
                Operations
              </span>
            </div>
            ...
            <form onSubmit={handleSubmit} className="p-6 sm:p-10 flex flex-col gap-6">
              <div>
                ...
                <input
                  ...
                  className="w-full bg-glaucous-50 border border-glaucous-200 rounded-lg p-3 text-base text-vivid-royal-950 placeholder:text-glaucous-600 focus:outline-none focus:border-coffee-bean-500 transition-all duration-300"
                />
              </div>
              ...
              <div className="grid sm:grid-cols-2 gap-6">
                <div>
                  ...
                  <select
                    ...
                    className="w-full bg-glaucous-50 border border-glaucous-200 rounded-lg p-3 text-base text-vivid-royal-950 focus:outline-none focus:border-coffee-bean-500 transition-all duration-300"
                  >
              ...
              <div>
                ...
                <textarea
                  ...
                  className="w-full bg-glaucous-50 border border-glaucous-200 rounded-lg p-3 text-base text-vivid-royal-950 placeholder:text-glaucous-600 focus:outline-none focus:border-coffee-bean-500 transition-all duration-300 resize-none"
                />
              </div>
              ...
              <button
                ...
                className="w-full text-center py-3.5 rounded-lg text-base font-bold uppercase tracking-wider text-coffee-bean-950 bg-coffee-bean-400 hover:bg-coffee-bean-500 disabled:bg-glaucous-200 disabled:text-glaucous-500 disabled:cursor-not-allowed transition-all duration-300 shadow-md mt-4 cursor-pointer select-none active:translate-y-[2px] active:scale-[0.98]"
              >
