    ...
    <main className="min-h-screen bg-glaucous-50 text-vivid-royal-950 pt-24 pb-20 relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-6 relative z-10">
        ...
        <div className="border-b border-glaucous-200 pb-16 mb-20">
          ...
          <h1 className="text-4xl sm:text-5xl lg:text-6xl font-extrabold text-vivid-royal-950 mt-3 mb-8 max-w-4xl leading-tight">
            We build systems that make good work repeatable.
          </h1>
          <div className="text-base sm:text-lg text-glaucous-800 max-w-2xl leading-relaxed space-y-3">
        ...
        <div className="flex flex-col gap-24">
          ...
          {/* What We Kept Seeing */}
          <section>
            <span className="text-xs font-mono font-bold tracking-widest text-glaucous-600 uppercase block mb-6">
              What We Kept Seeing
            </span>
            <p className="text-base sm:text-lg text-glaucous-900 leading-relaxed mb-10 max-w-2xl">
            ...
            <div className="grid md:grid-cols-2 gap-8">
              <div className="bg-white/60 border border-glaucous-200 rounded-xl p-8">
                <span className="font-mono text-[10px] text-glaucous-600 uppercase tracking-widest font-bold block mb-4">
                  They already had
                </span>
                <ul className="flex flex-col gap-3">
                  {["Websites", "Billing software", "CRMs", "WhatsApp Business"].map((item) => (
                    <li key={item} className="flex items-center gap-3 text-sm text-glaucous-800">
                      <span className="w-5 h-5 rounded-full bg-coffee-bean-100 flex items-center justify-center text-[10px] text-coffee-bean-600 font-bold">✓</span>
                      {item}
                    </li>
                  ))}
                </ul>
              ...
              <div className="bg-scarlet-fire-50/40 border border-scarlet-fire-200/50 rounded-xl p-8">
                <span className="font-mono text-[10px] text-scarlet-fire-600 uppercase tracking-widest font-bold block mb-4">
                ...
                <ul className="flex flex-col gap-3">
                  {[
                    ...
                    <li key={item} className="flex gap-3 items-start text-sm text-glaucous-800">
            ...
            <div className="mt-10 max-w-2xl">
              <p className="text-base sm:text-lg text-glaucous-900 leading-relaxed">
                The software wasn&apos;t missing.
              </p>
              <p className="text-base sm:text-lg text-glaucous-900 leading-relaxed">
                The connection between the work and the software was.
              </p>
              <p className="text-base sm:text-lg font-bold text-vivid-royal-950 mt-4">
          ...
          <section className="bg-vivid-royal-950/5 border border-vivid-royal-200/50 rounded-2xl p-8 sm:p-12 relative overflow-hidden">
            ...
            <div className="relative z-10">
              <span className="text-xs font-mono font-bold tracking-widest text-vivid-royal-600 uppercase block mb-6">
                Why ADX Exists
              </span>
              <div className="grid md:grid-cols-2 gap-8">
                ...
                <div className="bg-white/60 border border-glaucous-200 rounded-xl p-6 space-y-4 text-base sm:text-lg text-glaucous-900 leading-relaxed">
          ...
          <section>
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-5">
              {[
                ...
                >
                  <div className="w-8 h-8 rounded-full bg-coffee-bean-100 flex items-center justify-center text-sm text-coffee-bean-600 font-bold mb-4">
                    <svg className="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2.5}>
                      <path strokeLinecap="round" strokeLinejoin="round" d="M5 13l4 4L19 7" />
                    </svg>
                  </div>
                  <h3 className="text-base sm:text-lg font-bold text-vivid-royal-950 mb-2">{item.title}</h3>
                  <p className="text-sm text-glaucous-700 leading-relaxed">{item.desc}</p>
                </div>
              ))}
            </div>
          </section>
            ...
            <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-5">
              {[
                ...
                <div key={item.step} className="bg-white border border-glaucous-200 rounded-xl p-6">
                  <span className="font-mono text-[10px] font-bold text-glaucous-500 tracking-wider block mb-3">
                    STEP {item.step}
                  </span>
                  <p className="text-sm text-glaucous-900 leading-relaxed">{item.text}</p>
                </div>
              ))}
            </div>
          </section>
          ...
          <div className="grid md:grid-cols-2 gap-6">
            <section className="bg-white border border-glaucous-200 rounded-2xl p-8 sm:p-10 shadow-[0_2px_12px_rgba(66,47,208,0.04)]">
              <div className="w-12 h-12 rounded-full bg-coffee-bean-100 border border-coffee-bean-200 flex items-center justify-center text-coffee-bean-600 font-bold text-sm mb-5">
                MD
              </div>
              <span className="text-xs font-mono font-bold tracking-widest text-glaucous-600 uppercase block mb-4">
                Meet the Founder
              </span>
              <div className="text-sm sm:text-base text-glaucous-900 leading-relaxed space-y-3">
                <p className="text-lg font-bold text-vivid-royal-950">Hi, I&apos;m <strong>Mrigesh Deshpande</strong>.</p>
            ...
            <section className="bg-white border border-glaucous-200 rounded-2xl p-8 sm:p-10 shadow-[0_2px_12px_rgba(66,47,208,0.04)]">
              <div className="w-12 h-12 rounded-full bg-vivid-royal-100 border border-vivid-royal-200 flex items-center justify-center text-vivid-royal-600 font-bold text-sm mb-5">
                CC
              </div>
              <span className="text-xs font-mono font-bold tracking-widest text-glaucous-600 uppercase block mb-4">
                Meet the Co-Founder
              ...
              <div className="text-sm sm:text-base text-glaucous-900 leading-relaxed space-y-3">
                <p className="text-lg font-bold text-vivid-royal-950">Hi, I&apos;m <strong>Chakresh Chakshu</strong>.</p>
          ...
          <section className="relative text-center py-16 px-6">
            ...
            <div className="relative z-10 max-w-2xl mx-auto">
              ...
              <p className="text-base sm:text-lg text-glaucous-900 leading-relaxed mb-4">
              ...
              <p className="text-base sm:text-lg text-glaucous-900 leading-relaxed mb-8">
                If your team can focus on serving customers instead of chasing information, we&apos;ve done our job.
              </p>
              <p className="text-2xl sm:text-3xl font-bold text-vivid-royal-950">
